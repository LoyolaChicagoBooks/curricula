...
The initial motivation of this effort is to map our curriculum at Loyola University Chicago to the established international guidelines (ACM and IEEE).
We are motivated by the following research questions.
However, this topic is not of interest only to Loyola University Chicago. Everyone should be thinking about how what we do is relevant when it comes to various guidelines.
...
.. code-block:: bibtex
   ...
   @article{thiruvathukal_laufer_2023,
      title={LoyolaChicagoBooks/curricula: ACM/IEEE CS Curriculum Mapping Project },
...
- `George K. Thiruvathukal <https://gkt.sh>`__, *Professor and Chairperson*,Loyola University Chicago, CS Department and Visiting Computer Scientist, Argonne National Laboratory
- `Konstantin Läufer <https://laufer.cs.luc.edu>`__, *Professor* Loyola University Chicago, CS Department
